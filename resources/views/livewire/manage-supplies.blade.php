    ...
    <div class="overflow-auto rounded-lg border border-gray-200 shadow-md m-5">
        ...
        <div class="w-full m-4 flex">
            ...
            <div class="w-1/2 mx-2">
                ...
                <button  wire:click="showAddSuppliesModal"   type="button" class="focus:outline-none text-white bg-purple-700 hover:bg-purple-800 focus:ring-4 focus:ring-purple-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-purple-600 dark:hover:bg-purple-700 dark:focus:ring-purple-900">ADD</button>
